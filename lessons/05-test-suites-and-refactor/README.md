...
1. Continue to [Composition](../06-composition/) — struct embedding and method promotion
2. Then [Interfaces and Mocking](../07-interfaces-and-mocking/) — small consumer-defined interfaces
3. Later, [Design Patterns](../14-design-patterns/) — production architectural patterns in idiomatic Go
