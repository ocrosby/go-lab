...
go run ./lessons/08-goroutines-and-channels/primitives2.go
```
...
- Whole programs that wire these primitives together: [`10-worker-pools`](../10-worker-pools/)
- Measuring concurrent code: [`16-benchmarks`](../16-benchmarks/)
