...
1. Continue to [Composition](../05-composition/) — struct embedding and method promotion
2. Then [Interfaces and Mocking](../06-interfaces-and-mocking/) — small consumer-defined interfaces
3. Later, [Design Patterns](../13-design-patterns/) — production architectural patterns in idiomatic Go
