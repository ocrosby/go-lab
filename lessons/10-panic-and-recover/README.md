...
- Lesson 11: HTTP handlers (helpful, not required — this lesson also has HTTP examples).
...
go test ./lessons/10-panic-and-recover/http-panic/after/
...
go test ./lessons/10-panic-and-recover/http-panic/before/
```
...
- **Next lesson:** [11-http-clients-and-servers](../11-http-clients-and-servers/) — the HTTP fundamentals that lesson 10's `http-panic` sub-lesson builds on.
