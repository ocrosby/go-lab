...
```bash
go test -v ./lessons/03-testing-basics
```
...
PASS
ok  	github.com/ocrosby/go-lab/lessons/03-testing-basics	0.003s
```
...
- **Next lesson:** [04-test-suites-and-refactor](../04-test-suites-and-refactor/) — a second testing style (Ginkgo) and using tests as a safety net during refactors.
