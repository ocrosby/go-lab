...
```bash
go run ./learning/03-advanced/concurrency/done.go
go run ./learning/03-advanced/concurrency/pipeline.go
```
...
- Whole programs that wire these primitives together: [`examples/03-advanced/concurrency/`](../../../examples/03-advanced/concurrency/)
- Measuring concurrent code: [`examples/03-advanced/performance-benchmarks/`](../../../examples/03-advanced/performance-benchmarks/)
